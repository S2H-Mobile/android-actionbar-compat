...
public class BitmapFileTask extends AsyncTask<Integer, Void, Bitmap> {	
    ...
    private static Bitmap decodeBitmapFromFile(String path, int targetWidth, int targetHeight) { 	
        ...
        if (targetWidth != 0 && targetHeight != 0 
        	...
        	realFactor = Math.min(imageWidth/targetWidth, imageHeight/targetHeight);
        }
        // TODO this is probably not necessary, the scale factor will be a power of two anyway
